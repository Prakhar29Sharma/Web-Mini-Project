...
export default function CreateProfile() {
    ...
    function MultipleSelect(props) {
        ...
        isMulti
        options={props.list}
        onChange={(selectedValues) => setSelectedSubjectOfInterest(selectedValues) }
        value={selectedSubjectOfInterest}
        isSearchable= {true}
        />
    }
...
export async function action({request}) {
    ...
    axios.post('http://localhost:5000/api/evaluator/', formToJSON, {
      headers: {
